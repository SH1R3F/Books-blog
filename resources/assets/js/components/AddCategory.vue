      ...
      <div class="card-body">
        ...
        <form action="/manage/categories" method="post">
          ...
          <div class="form-group">
            <input type="submit" value="إضافة" class="btn btn-primary" :disabled="cantSubmit || disableBtn" @click.prevent="addCategory">
          </div><!-- form group -->
...
export default {
  ...
  methods: {
    ...
    addCategory: function(){
      ...
      axios.post(APP_URL + '/manage/category', {'title': this.title}).then(response => {
